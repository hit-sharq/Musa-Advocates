...
import { ArrowUpRight, Check, ChevronRight, Clock3, Mail, MapPin, Menu, Phone, Scale, ShieldCheck } from 'lucide-react'

const practices = [
  ['01', 'Civil Litigation', 'Strategic representation for disputes, contracts, property claims and commercial matters.'],
  ['02', 'Criminal Defence', 'A considered, diligent defence from first advice through trial and appeal.'],
  ['03', 'Family & Succession', 'Discreet guidance through divorce, custody, succession and matrimonial property matters.'],
  ['04', 'Corporate & Commercial', 'Clear counsel for companies, entrepreneurs, contracts and business transactions.'],
  ['05', 'Property & Conveyancing', 'Careful title reviews, land transactions, leases and conveyancing across Kenya.'],
  ['06', 'Accident & Compensation', 'Practical representation for injury claims, including visitors and expatriates in Kenya.'],
]
  ...
  return (
    <main>
      ...
      <header className="site-header"><div className="shell nav-wrap">
        ...
        <a className="button button-dark nav-cta" href="/contact">Book a consultation <ArrowUpRight size={16} /></a>
      ...
      <section className="hero" id="top"><div className="shell hero-grid">
        <div className="hero-copy"><p className="eyebrow">EXCELLENCE IN LEGAL PRACTICE</p><h1>Duty, trust, and precision <em>in every matter.</em></h1><p className="hero-lead">Musa &amp; Musa Advocates is a Nairobi-based law firm helping individuals, families and businesses navigate complex legal matters with confidence.</p><div className="hero-actions"><a className="button button-blue" href="/contact">Speak with an advocate <ArrowUpRight size={17} /></a><a className="text-link" href="/practice-areas">Explore our practice areas <ChevronRight size={16} /></a></div><div className="hero-proof"><span><ShieldCheck size={18} /> Client-focused</span><span><Scale size={18} /> Kenyan law</span><span><Check size={18} /> Professional</span></div></div>
      ...
      <section className="insight-band section" id="insights"><div className="shell insight-grid"><div><p className="eyebrow">FROM OUR INSIGHTS</p><h2>Useful legal perspective, made accessible.</h2><p>Explore practical explainers and updates on Kenyan law, rights, business and justice.</p><a className="button button-light" href="/contact">Visit legal insights <ArrowUpRight size={16} /></a></div><div className="insight-card"><span className="insight-tag">LEGAL GUIDE · 06 MIN READ</span><h3>What to do after a road traffic accident in Kenya</h3><p>The first steps can affect your claim. Here is a clear starting point for protecting your rights.</p><a href="/contact">Read the guide <ChevronRight size={15} /></a></div></div></section>

      <section className="contact section" id="contact"><div className="shell contact-box"><div><p className="eyebrow">START A CONVERSATION</p><h2>Let us discuss what matters to you.</h2><p>Share a little about your legal matter and our team will get back to you with the next step.</p></div><div className="contact-details"><a href="mailto:info@musadvocates.co.ke"><Mail size={19} /> info@musadvocates.co.ke</a><a href="tel:+254758251399"><Phone size={19} /> +254 758 251 399</a><span><MapPin size={19} /> 6076 Rhapta Road, Nairobi</span><a className="button button-blue" href="mailto:info@musadvocates.co.ke">Request a consultation <ArrowUpRight size={16} /></a></div></div></section>
